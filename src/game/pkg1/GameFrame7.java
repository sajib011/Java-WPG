...
public class GameFrame7 extends JFrame implements ActionListener {
    ...
    GameFrame7() {
        ...
        sugg3 = new JLabel("A word with 4 alphabet") ;
        add(sugg3) ;
        ...
        if(e.getSource() == label3)
        {
            if(mf1 == 0)
            {
                if(flag1 == 2)
                {
                    ...
                    if(matches == 4)
                    {
                        int x = JOptionPane.showConfirmDialog(null, "You've completed all levels!!", "Full Match", 0) ;

...
public class GameFrame6 extends JFrame implements ActionListener {
    ...
    GameFrame6() {
       ...
       //for the text field
        ...
        sugg2 = new JLabel("A word with 2 alphabett") ;
        add(sugg2) ;
        ...
        //button aaa
        img1 = new ImageIcon(getClass().getResource("sss.jpg"));
        ...
        //button ppp
        img2 = new ImageIcon(getClass().getResource("iii.jpg"));
        label2 = new JButton(img2);
        add(label2);
        label2.setLocation(500, 350);
        label2.setSize(100, 100);
        //button ccc
        img3 = new ImageIcon(getClass().getResource("kkk.jpg"));
